...
public:
    SpinSlashSkill() : Skill("Spin Slash", "Damages all enemies within movement range.", 15) {}
...
public:
    HelmSmashSkill() : Skill("Helm Smash", "Massive damage & Stun to 1 adjacent enemy.", 20) {}
    bool execute(Character& caster, GameState& state) override {
...
public:
    TauntSkill() : Skill("Taunt", "Forces all enemies to attack the Knight.", 10) {}
    bool execute(Character& caster, GameState& state) override {
