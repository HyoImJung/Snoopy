...
struct Character {
    ...
    Character(std::string n, CharacterClass c, int px, int py,
              int h, int a, int mv, int ar, bool ally)
        : name(n), cls(c), x(px), y(py),
          hp(h), maxHp(h), atk(a), moveRange(mv), atkRange(ar),
    ...
    std::string getIcon() const {
        ...
        case CharacterClass::MAGE:      return "W";
