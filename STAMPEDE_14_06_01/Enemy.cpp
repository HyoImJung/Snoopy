...
// Slime 구현
Slime::Slime(int px, int py) : Character("슬라임", CharacterClass::ENEMY_SLIME, px, py, 10, 2, 1, 1, false), hasSplit(false), splitPending(false) {}
...
// Goblin 구현
Goblin::Goblin(int px, int py) : Character("고블린", CharacterClass::ENEMY_GOBLIN, px, py, 8, 4, 1, 1, false) {}
bool Goblin::performAttack(char dir, GameState& state) { return true; }

// Orc 구현
Orc::Orc(int px, int py) : Character("오크", CharacterClass::ENEMY_ORC, px, py, 20, 3, 1, 1, false) {}
bool Orc::performAttack(char dir, GameState& state) { return false; }

// Undead 구현
Undead::Undead(int px, int py) : Character("언데드", CharacterClass::ENEMY_UNDEAD, px, py, 15, 3, 1, 1, false) {}
bool Undead::performAttack(char dir, GameState& state) { return false; }

// Demon 구현
Demon::Demon(int px, int py) : Character("악마", CharacterClass::ENEMY_DEMON, px, py, 30, 6, 1, 1, false) {}
